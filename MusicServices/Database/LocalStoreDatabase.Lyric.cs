...
#nullable enable
        ...
        {
            RawLyricToCleanReply(rawLyric: lyric.LyricText, ref lyric);
        ...
        public void RawLyricToCleanReply(string rawLyric, ref LyricsOvh_Reply lyric)
        {
            string[] rawSplit = rawLyric.Split("\r\n", 2, StringSplitOptions.RemoveEmptyEntries);

            //get rid of useless parts form the LyricsOvh_Reply
            lyric.LyricText = rawSplit[rawSplit.Length-1];
